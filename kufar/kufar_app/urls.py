...
urlpatterns = [
    ...
    path('add_phone_announcement/', views.add_phone_announcement, name = 'add_phone_announcement'),
    path('add_tablet_announcement/', views.add_tablet_announcement, name = 'add_tablet_announcement'),
    path('add_car_announcement/', views.add_car_announcement, name = 'add_car_announcement'),
    path('add_computer_announcement/', views.add_computer_announcement, name = 'add_computer_announcement'),
